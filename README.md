...
Latest release page: [v0.3.6](https://github.com/rookepoole/LittleBird/releases/tag/v0.3.6)
...
```powershell
.\scripts\build-windows-installer.ps1 -Version 0.3.6
```
...
Tag a release such as `v0.3.6` and the GitHub Actions workflow can publish the installer asset. Little Bird never silently installs updates; it only checks the feed and opens the installer download when the user chooses it.
