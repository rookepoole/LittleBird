...
Latest release page: [v0.3.1](https://github.com/rookepoole/LittleBird/releases/tag/v0.3.1)
...
```powershell
.\scripts\build-windows-installer.ps1 -Version 0.3.1
```
...
Tag a release such as `v0.3.1` and the GitHub Actions workflow can publish the installer asset. Little Bird never silently installs updates; it only checks the feed and opens the installer download when the user chooses it.
