...
Latest release page: [v0.3.10](https://github.com/rookepoole/LittleBird/releases/tag/v0.3.10)
...
```powershell
.\scripts\build-windows-installer.ps1 -Version 0.3.10
```
...
Tag a release such as `v0.3.10` and the GitHub Actions workflow can publish the installer asset. Little Bird never silently installs updates; after the user chooses Install, it downloads the trusted GitHub installer, verifies the release digest when available, and opens the Windows installer.
